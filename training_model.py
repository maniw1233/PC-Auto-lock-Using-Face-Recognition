...
detector = cv2.CascadeClassifier("C:\\Users\\heman\\Downloads\\Lock-Unlock-Laptop-PC-Screen-Using-Face-Recognition-master (1)\\Lock-Unlock-Laptop-PC-Screen-Using-Face-Recognition-master\\haarcascade_frontalface_default.xml")
...
faces,ids = getImagesAndLabels('C:\\Users\\heman\\Downloads\\Lock-Unlock-Laptop-PC-Screen-Using-Face-Recognition-master (1)\\Lock-Unlock-Laptop-PC-Screen-Using-Face-Recognition-master\\dataset')  # Get the faces and IDs

recognizer.train(faces, np.array(ids)) # Train the model using the faces and IDs

assure_path_exists('C:\\Users\\heman\\Downloads\\Lock-Unlock-Laptop-PC-Screen-Using-Face-Recognition-master (1)\\Lock-Unlock-Laptop-PC-Screen-Using-Face-Recognition-master\\trainer\\')    # Save the model into trainer.yml
recognizer.save('C:\\Users\\heman\\Downloads\\Lock-Unlock-Laptop-PC-Screen-Using-Face-Recognition-master (1)\\Lock-Unlock-Laptop-PC-Screen-Using-Face-Recognition-master\\trainer\\trainer.yml')
